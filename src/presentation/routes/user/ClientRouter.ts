...
import { createPost,uploadImage ,getClientPost,userPosts,listPosts,requestProject,changeStatus,findMyRequests,myApprovedProjects,createCheckout,successPayment} from '../../../controllers/user/ClientContoller';
const router=Router()
